  ...
  return (
    <div className="login-page">
      <div className="login-card">
        <h1 className="login-brand">Huddle Notes</h1>
        <p className="login-tagline">
          Type together. Think together.
        </p>
        ...
        {/* <p className="login-footnote">No password needed - just your Google account.</p> */}
      </div>
    </div>
  );
}

// Standard multi-color Google "G" mark, inline as SVG so no extra asset/network request is needed
function GoogleIcon() {
  return (
